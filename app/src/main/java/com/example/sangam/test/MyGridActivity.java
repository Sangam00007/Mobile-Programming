...
import com.example.sangam.Classwork.ListViewActivity;
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            ...
            grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    //todo : grab the title and show it in toast
                    String title = parent.getItemAtPosition(position).toString();
                    Toast.makeText(MyGridActivity.this, "Item Clicked" +title, Toast.LENGTH_SHORT).show();
                }
            });
    }
}